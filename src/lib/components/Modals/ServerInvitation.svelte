...
<div class="Invitation">
	<main>
		<header>
			...
			<h3>Server members have access to all the sites on this server and can create new sites.</h3>
		</header>
		<form on:submit|preventDefault={invite_editor}>
			<label class="subheading" for="email">Enter collaborator email</label>
			<div>
				<div class="input-group">
					<input bind:value={email} type="text" placeholder="Email address" name="email" />
